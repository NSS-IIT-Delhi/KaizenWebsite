...
*/ ;(function (
                    ...
                    for (i in o)
                        (e = s[i]),
                            ...
                            s !== r &&
                                (c &&
                                r &&
                                (b.isPlainObject(r) || (n = b.isArray(r)))
                                    ? (n
                                          ? ((n = !1),
                                            (a = e && b.isArray(e) ? e : []))
                                          : (a =
            ...
            parseJSON: function (n) {
                return e.JSON && e.JSON.parse
                    ...
                    : "string" == typeof n &&
                      ...
                      n &&
                          k.test(
                              n.replace(S, "@").replace(A, "]").replace(E, "")
                          ))
                    ? Function("return " + n)()
        ...
        (b.support = (function () {
            ...
            ;(s = o.createElement("select")),
                ...
                (t = {
                    ...
                    html5Clone:
                        "<:nav></:nav>" !==
                        o.createElement("nav").cloneNode(!0).outerHTML,
        ...
        if (b.acceptData(e)) {
            ...
            if ((f && p[f] && (i || p[f].data)) || !u || r !== t)
                return (
                    ...
                    u
                        ? ((a = o[n]), null == a && (a = o[b.camelCase(n)]))
                        : (a = o),
                    a
                )
        }
    ...
    ;(b.event = {
                        ...
                        (d = b.extend(
                            {
                                ...
                                selector: a,
                                needsContext:
                                    a && b.expr.match.needsContext.test(a),
                                namespace: m.join("."),
                            },
                            c
                        )),
        ...
        trigger: function (n, r, i, a) {
            ...
            if (
                ...
                3 !== i.nodeType &&
                    ...
                    (n = n[b.expando]
                        ? n
                        : new b.Event(g, "object" == typeof n && n)),
                    (n.isTrigger = !0),
                    (n.namespace = m.join(".")),
                ...
                while ((o = s[n++]) && !e.isPropagationStopped()) {
                    ...
                    while (
                        ...
                        (!e.namespace_re || e.namespace_re.test(i.namespace)) &&
                            ...
                            (e.data = i.data),
                            (r = (
                                (b.event.special[i.origType] || {}).handle ||
                                i.handler
                            ).apply(o.elem, u)),
                            r !== t &&
                                (e.result = r) === !1 &&
        ...
        special: {
            ...
            blur: {
                trigger: function () {
                    return this === o.activeElement && this.blur
                        ? (this.blur(), !1)
                        : t
                },
        ...
        b.support.changeBubbles ||
            (b.event.special.change = {
                ...
                teardown: function () {
                    return (
                        b.event.remove(this, "._change"), !Z.test(this.nodeName)
                    )
                },
            }),
                        ...
                        if ((a = i[1])) {
                            ...
                            if (i[2])
                                return (
                                    H.apply(
                                        n,
                                        q.call(t.getElementsByTagName(e), 0)
                                    ),
                                    n
                                )
                            if (
                                ...
                                return (
                                    H.apply(
                                        n,
                                        q.call(t.getElementsByClassName(a), 0)
                                    ),
                                    n
                                )
                        }
                    ...
                    return n !== p && 9 === n.nodeType && n.documentElement
                        ? ((p = n),
                          ...
                          (T.attributes = at(function (e) {
                              ...
                              var t = typeof e.lastChild.getAttribute(
                                  "multiple"
                              )
    ...
    var ht =
        ...
        At = {
            ...
            _default: b.support.htmlSerialize
                ? [0, "", ""]
                : [1, "X<div>", "</div>"],
        },
        jt = dt(o),
        ...
        b(function () {
            b.support.reliableMarginRight ||
                (b.cssHooks.marginRight = {
                    get: function (e, n) {
                        return n
                            ? b.swap(e, { display: "inline-block" }, Wt, [
                                  e,
                                  "marginRight",
                              ])
                            : t
                ...
                b
                    ...
                    .done(function (e) {
                        ;(o = arguments),
                            s.html(
                                i
                                    ? b("<div>").append(b.parseHTML(e)).find(i)
                                    : e
                            )
                    })
                    .complete(
