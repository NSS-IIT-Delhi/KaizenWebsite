    ...
    return $
        ? (($.Unslider = function (t, n) {
              ...
              return (
                  ...
                  (e.init = function (t) {
                      return (
                          ...
                          (e.$slides = e.$container.children(
                              e.options.selectors.slides
                          )),
                          e.setup(),
                          $.each(
                              ["nav", "arrows", "keys", "infinite"],
                              function (t, n) {
                  ...
                  (e.initNav = function () {
                      ...
                      e.$slides.each(function (n) {
                          ...
                          e.$nav
                              .find("li")
                              .on("click" + e.eventSuffix, function () {
                                  var t = $(this).addClass(
                                      e.options.activeClass
                                  )
                                  t
                                      .siblings()
                  ...
                  (e.initArrows = function () {
                      e.options.arrows === !0 &&
                          (e.options.arrows = e.defaults.arrows),
                  ...
                  (e.initKeys = function () {
                      e.options.keys === !0 &&
                          (e.options.keys = e.defaults.keys),
                      ...
                      "fade" !== e.options.animation &&
                          e.$container.on({
                              movestart: function (t) {
                                  return (t.distX > t.distY &&
                                      t.distX < -t.distY) ||
                                      (t.distX < t.distY && t.distX > -t.distY)
                                      ? !!t.preventDefault()
                                      : void e.$container.css(
                                            "position",
                                            "relative"
                                        )
                              },
          ...
          ($.fn._move = function () {
              return (
                  this.stop(!0, !0),
                  $.fn[$.fn.velocity ? "velocity" : "animate"].apply(
                      this,
                      arguments
                  )
              )
